        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/ss.png" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Menu category<span class="sr-only"></span></a> </li>
						...
						if(empty($_SESSION["user_id"])) 
						...
						else
							{
									...
									echo  '<li class="nav-item"><a href="contact_details.html" class="nav-link active">Contact</a> </li>';
									echo  '<li class="nav-item"><a href="about_us.html" class="nav-link active">About us</a> </li>';
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs">Search Your Favourite Food</h5>
                    <div class="banner-form">
                        <form action="search.php" method="get" class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to eat....</label>
                                <div class="form-group">
            <input type="text" name="q"  class="form-control form-control-lg" id="exampleInputAmount" placeholder="I would like to eat...."> </div>
                            </div>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>The Grill & Coffee Co.</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2><b>Specials of the Month</b></h2>
                ...
                <div class="row">
						...
						<div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
															...
															<div class="content">
																...
																<div class="price-btn-block"> <span class="price">R'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
															</div>
                        ...
                        <div class="restaurants-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
									...
									$res= mysqli_query($db,"select * from dishes_category");
                    ...
                    <div class="restaurant-listing">
						...
						$ress= mysqli_query($db,"select * from restaurant");  
									      while($rows=mysqli_fetch_array($ress))
										  {
													...
													$query= mysqli_query($db,"select * from dishes_category where c_id='".$rows['c_id']."' ");
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/ss.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                   <ul>
                            <li><a href="#">College View Stand No. 225,</a> </li>
                            <li><a href="#">Bushbackridge,</a> </li>
                            <li><a href="#">1280</a> </li>                          
                        </ul>
                                    <h5>Phone: <a href="tel:+27785920645">078 592 0645</a></h5>
									<h5>Email: <a href="vonixiluva@gmail.com">vonixiluva@gmail.com</a></h5>
